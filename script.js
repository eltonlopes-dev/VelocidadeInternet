...
async function runPingTest() {
    ...
    // Barra de progresso invertida para o ping (menor ping = barra mais cheia/saudável)
...
startBtn.addEventListener('click', async () => {
    ...
    try {
        // Sequência de testes idêntica aos profissionais
        await runPingTest();
        await new Promise(resolve => setTimeout(resolve, 800)); // Delay estético de transição
